    ...
    return (
        <div className="space-y-8 pb-12">
            ...
            <div className="bg-white rounded-2xl border border-border/50 shadow-soft overflow-hidden">
                ...
                {/* Mobile Card View */}
                <div className="md:hidden max-h-[500px] overflow-y-auto custom-scrollbar divide-y divide-border/50">
                    {borrower.loans && borrower.loans.length > 0 ? (
                        borrower.loans.map((loan) => (
                            <div key={loan.id} className="p-4 space-y-3">
                                ...
                                <div className="flex justify-between items-start">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="font-bold text-gray-900">{new Date(loan.date_borrowed).toLocaleDateString()}</span>
                                    </div>
                                    {loan.status === 'paid' ? (
                                        ...
                                        <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-semibold bg-blue-50 text-blue-700 border border-blue-100">
